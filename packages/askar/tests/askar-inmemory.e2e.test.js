...
const aliceInMemoryAgentOptions = (0, helpers_1.getSqliteAgentOptions)('AgentsAlice', {
    endpoints: ['rxjs:alice'],
}, true);
const bobInMemoryAgentOptions = (0, helpers_1.getSqliteAgentOptions)('AgentsBob', {
    endpoints: ['rxjs:bob'],
}, true);
// FIXME: Re-include in tests when Askar NodeJS wrapper performance is improved
(0, runInVersion_1.describeRunInNodeVersion)([18], 'Askar In Memory agents', () => {
    let aliceAgent;
    let bobAgent;
    ...
    test('In memory Askar wallets E2E test', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        aliceAgent = new core_1.Agent(aliceInMemoryAgentOptions);
        ...
        bobAgent = new core_1.Agent(bobInMemoryAgentOptions);
