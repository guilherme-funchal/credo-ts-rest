...
const IndySdkSovDidResolver_1 = require("../IndySdkSovDidResolver");
...
(0, helpers_1.mockFunction)(indySdkPoolServiceMock.getPoolForDid).mockResolvedValue({
    pool: { config: { indyNamespace: 'pool1' } },
});
const agentConfig = (0, helpers_1.getAgentConfig)('IndySdkSovDidResolver');
...
const indySdkSovDidResolver = new IndySdkSovDidResolver_1.IndySdkSovDidResolver();
describe('IndySdkSovDidResolver', () => {
    it('should correctly resolve a did:sov document', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const result = yield indySdkSovDidResolver.resolve(agentContext, did, (0, parse_1.parseDid)(did));
