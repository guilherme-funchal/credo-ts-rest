...
describe('Utils | Did', () => {
    describe('isSelfCertifiedDid()', () => {
        test('returns true if the verkey is abbreviated', () => {
            expect((0, did_1.isLegacySelfCertifiedDid)('PW8ZHpNupeWXbmpPWog6Ki', '~QQ5jiH1dgXPAnvHdJvazn9')).toBe(true);
        });
        test('returns true if the verkey is not abbreviated and the did is generated from the verkey', () => {
            expect((0, did_1.isLegacySelfCertifiedDid)('Y8q4Aq6gRAcmB6jjKk3Z7t', 'HyEoPRNvC7q4jj5joUo8AWYtxbNccbEnTAeuMYkpmNS2')).toBe(true);
        });
        test('returns false if the verkey is not abbreviated and the did is not generated from the verkey', () => {
            expect((0, did_1.isLegacySelfCertifiedDid)('Y8q4Aq6gRAcmB6jjKk3Z7t', 'AcU7DnRqoXGYATD6VqsRq4eHuz55gdM3uzFBEhFd6rGh')).toBe(false);
        });
    });
