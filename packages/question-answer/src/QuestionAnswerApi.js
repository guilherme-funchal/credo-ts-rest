...
let QuestionAnswerApi = (() => {
    let _classDecorators = [(0, core_1.injectable)()];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var QuestionAnswerApi = _classThis = class {
         ...
         */
        sendQuestion(connectionId, config) {
            return __awaiter(this, void 0, void 0, function* () {
                const connection = yield this.connectionService.getById(this.agentContext, connectionId);
                connection.assertReady();
                const { questionMessage, questionAnswerRecord } = yield this.questionAnswerService.createQuestion(this.agentContext, connectionId, {
         ...
         * @returns QuestionAnswer record
         */
        sendAnswer(questionRecordId, response) {
            return __awaiter(this, void 0, void 0, function* () {
                const questionRecord = yield this.questionAnswerService.getById(this.agentContext, questionRecordId);
                const { answerMessage, questionAnswerRecord } = yield this.questionAnswerService.createAnswer(this.agentContext, questionRecord, response);
                const connection = yield this.connectionService.getById(this.agentContext, questionRecord.connectionId);
                const outboundMessageContext = yield (0, core_1.getOutboundMessageContext)(this.agentContext, {
    ...
    __setFunctionName(_classThis, "QuestionAnswerApi");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        QuestionAnswerApi = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return QuestionAnswerApi = _classThis;
})();
