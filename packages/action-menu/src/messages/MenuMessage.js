...
let MenuMessage = (() => {
    ...
    return _a = class MenuMessage extends _classSuper {
            constructor(options) {
                var _b;
                super();
                ...
                this.errorMessage = (__runInitializers(this, _description_extraInitializers), __runInitializers(this, _errorMessage_initializers, void 0));
                this.options = (__runInitializers(this, _errorMessage_extraInitializers), __runInitializers(this, _options_initializers, void 0));
        ...
        (() => {
            ...
            _type_decorators = [(0, core_1.IsValidMessageType)(MenuMessage.type)];
            _title_decorators = [(0, class_validator_1.IsString)()];
            _description_decorators = [(0, class_validator_1.IsString)()];
            _errorMessage_decorators = [(0, class_transformer_1.Expose)({ name: 'errormsg' }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            _options_decorators = [(0, class_validator_1.IsInstance)(models_1.ActionMenuOption, { each: true }), (0, class_transformer_1.Type)(() => models_1.ActionMenuOption)];
        ...
        _a.type = (0, core_1.parseMessageType)('https://didcomm.org/action-menu/1.0/menu'),
        _a;
})();
