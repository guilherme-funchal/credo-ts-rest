...
let SchemaRegistry = (() => {
    ...
    let _classThis;
    let _classSuper = BaseContract_1.BaseContract;
    var SchemaRegistry = _classThis = class extends _classSuper {
        constructor(client) {
            super(client);
        }
    ...
    __setFunctionName(_classThis, "SchemaRegistry");
    (() => {
        var _a;
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        SchemaRegistry = _classThis = _classDescriptor.value;
    ...
    return SchemaRegistry = _classThis;
})();
