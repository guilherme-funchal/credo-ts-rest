...
exports.PushNotificationsApnsDeviceInfoMessage = void 0;
 ...
 */
let PushNotificationsApnsDeviceInfoMessage = (() => {
    var _a;
    ...
    return _a = class PushNotificationsApnsDeviceInfoMessage extends _classSuper {
            constructor(options) {
                var _b;
                super();
                this.type = __runInitializers(this, _type_initializers, _a.type.messageTypeUri);
                this.deviceToken = (__runInitializers(this, _type_extraInitializers), __runInitializers(this, _deviceToken_initializers, void 0));
        ...
        (() => {
            ...
            _type_decorators = [(0, core_1.IsValidMessageType)(PushNotificationsApnsDeviceInfoMessage.type)];
        ...
        _a.type = (0, core_1.parseMessageType)('https://didcomm.org/push-notifications-apns/1.0/device-info'),
        _a;
})();
exports.PushNotificationsApnsDeviceInfoMessage = PushNotificationsApnsDeviceInfoMessage;
