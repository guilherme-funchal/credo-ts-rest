...
exports.PushNotificationsApnsSetDeviceInfoMessage = void 0;
 ...
 */
let PushNotificationsApnsSetDeviceInfoMessage = (() => {
    var _a;
    ...
    return _a = class PushNotificationsApnsSetDeviceInfoMessage extends _classSuper {
            constructor(options) {
                var _b;
                super();
                this.deviceToken = __runInitializers(this, _deviceToken_initializers, void 0);
                this.type = (__runInitializers(this, _deviceToken_extraInitializers), __runInitializers(this, _type_initializers, _a.type.messageTypeUri));
        ...
        (() => {
            ...
            _type_decorators = [(0, core_1.IsValidMessageType)(PushNotificationsApnsSetDeviceInfoMessage.type)];
        ...
        _a.type = (0, core_1.parseMessageType)('https://didcomm.org/push-notifications-apns/1.0/set-device-info'),
        _a;
})();
exports.PushNotificationsApnsSetDeviceInfoMessage = PushNotificationsApnsSetDeviceInfoMessage;
