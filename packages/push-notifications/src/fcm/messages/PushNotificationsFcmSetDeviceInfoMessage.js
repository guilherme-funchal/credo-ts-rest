...
exports.PushNotificationsFcmSetDeviceInfoMessage = void 0;
 ...
 */
let PushNotificationsFcmSetDeviceInfoMessage = (() => {
    var _a;
    ...
    return _a = class PushNotificationsFcmSetDeviceInfoMessage extends _classSuper {
            constructor(options) {
                var _b;
                super();
        ...
        (() => {
            ...
            _type_decorators = [(0, core_1.IsValidMessageType)(PushNotificationsFcmSetDeviceInfoMessage.type)];
        ...
        _a.type = (0, core_1.parseMessageType)('https://didcomm.org/push-notifications-fcm/1.0/set-device-info'),
        _a;
})();
exports.PushNotificationsFcmSetDeviceInfoMessage = PushNotificationsFcmSetDeviceInfoMessage;
