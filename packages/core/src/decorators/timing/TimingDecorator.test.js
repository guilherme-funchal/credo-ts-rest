...
describe('Decorators | TimingDecorator', () => {
    it('should correctly transform Json to TimingDecorator class', () => {
        ...
        const decorator = JsonTransformer_1.JsonTransformer.fromJSON(json, TimingDecorator_1.TimingDecorator);
    ...
    it('should correctly transform TimingDecorator class to Json', () => {
        ...
        const decorator = new TimingDecorator_1.TimingDecorator({
            inTime,
            outTime,
            staleTime,
            expiresTime,
        ...
        const jsonString = JsonTransformer_1.JsonTransformer.serialize(decorator);
