...
describe('Decorators | ThreadDecorator', () => {
    it('should correctly transform Json to ThreadDecorator class', () => {
        ...
        const decorator = JsonTransformer_1.JsonTransformer.fromJSON(json, ThreadDecorator_1.ThreadDecorator);
    ...
    it('should correctly transform ThreadDecorator class to Json', () => {
        ...
        const decorator = new ThreadDecorator_1.ThreadDecorator({
            threadId,
            parentThreadId,
            senderOrder,
            receivedOrders,
