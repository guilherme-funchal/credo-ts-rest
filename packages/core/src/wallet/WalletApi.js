...
let WalletApi = (() => {
    ...
    let _classThis;
    var WalletApi = _classThis = class {
        ...
        createAndOpen(walletConfig) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                yield this.wallet.createAndOpen(walletConfig);
                this._walletConfig = walletConfig;
                // Store the storage version in the wallet
                yield this.storageUpdateService.setCurrentStorageVersion(this.agentContext, updates_1.CURRENT_FRAMEWORK_STORAGE_VERSION);
            });
        }
        create(walletConfig) {
            return __awaiter(this, void 0, void 0, function* () {
        ...
        open(walletConfig) {
            return __awaiter(this, void 0, void 0, function* () {
                yield this.wallet.open(walletConfig);
                this._walletConfig = walletConfig;
            });
        }
        close() {
        ...
        rotateKey(walletConfig) {
            return __awaiter(this, void 0, void 0, function* () {
                yield this.wallet.rotateKey(walletConfig);
            });
        }
        generateNonce() {
            return __awaiter(this, void 0, void 0, function* () {
                return yield this.wallet.generateNonce();
            });
        }
        delete() {
            return __awaiter(this, void 0, void 0, function* () {
        ...
        export(exportConfig) {
            return __awaiter(this, void 0, void 0, function* () {
                yield this.wallet.export(exportConfig);
            });
        }
        import(walletConfig, importConfig) {
            return __awaiter(this, void 0, void 0, function* () {
                yield this.wallet.import(walletConfig, importConfig);
            });
        }
        /**
    ...
    __setFunctionName(_classThis, "WalletApi");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        WalletApi = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return WalletApi = _classThis;
})();
