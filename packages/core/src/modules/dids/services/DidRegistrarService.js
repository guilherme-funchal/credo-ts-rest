...
let DidRegistrarService = (() => {
    let _classDecorators = [(0, plugins_1.injectable)()];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var DidRegistrarService = _classThis = class {
        ...
        create(agentContext, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return yield registrar.create(agentContext, options);
            });
        }
        update(agentContext, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return yield registrar.update(agentContext, options);
            });
        }
        deactivate(agentContext, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return yield registrar.deactivate(agentContext, options);
            });
        }
    ...
    __setFunctionName(_classThis, "DidRegistrarService");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        DidRegistrarService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return DidRegistrarService = _classThis;
})();
