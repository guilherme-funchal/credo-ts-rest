...
let ForwardMessage = (() => {
    ...
    return _a = class ForwardMessage extends _classSuper {
            /**
            ...
            constructor(options) {
                ...
                this.to = (__runInitializers(this, _type_extraInitializers), __runInitializers(this, _to_initializers, void 0));
                this.message = (__runInitializers(this, _to_extraInitializers), __runInitializers(this, _message_initializers, void 0));
        ...
        (() => {
            ...
            _type_decorators = [(0, messageType_1.IsValidMessageType)(ForwardMessage.type)];
            _to_decorators = [(0, class_validator_1.IsString)()];
            _message_decorators = [(0, class_transformer_1.Expose)({ name: 'msg' }), (0, class_validator_1.IsObject)()];
        ...
        _a.type = (0, messageType_1.parseMessageType)('https://didcomm.org/routing/1.0/forward'),
        _a;
})();
