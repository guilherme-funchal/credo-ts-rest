...
class DidExchangeResponseHandler {
    ...
    handle(messageContext) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const connectionRecord = yield this.connectionService.getByRoleAndThreadId(agentContext, models_2.DidExchangeRole.Requester, message.threadId);
            if (!connectionRecord) {
            ...
            const ourDidDocument = yield this.didResolverService.resolveDidDocument(agentContext, connectionRecord.did);
            if (!ourDidDocument) {
            ...
            const outOfBandRecord = yield this.outOfBandService.findById(agentContext, connectionRecord.outOfBandId);
            if (!outOfBandRecord) {
            ...
            const connection = yield this.didExchangeProtocol.processResponse(messageContext, outOfBandRecord);
            ...
            if ((_a = connection.autoAcceptConnection) !== null && _a !== void 0 ? _a : this.connectionsModuleConfig.autoAcceptConnections) {
                const message = yield this.didExchangeProtocol.createComplete(agentContext, connection, outOfBandRecord);
                ...
                if (!outOfBandRecord.reusable) {
                    yield this.outOfBandService.updateState(agentContext, outOfBandRecord, OutOfBandState_1.OutOfBandState.Done);
                }
