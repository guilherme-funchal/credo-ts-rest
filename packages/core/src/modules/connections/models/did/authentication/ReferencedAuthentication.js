...
let ReferencedAuthentication = (() => {
    ...
    return _a = class ReferencedAuthentication extends _classSuper {
            constructor(publicKey, type) {
                super();
                this.type = __runInitializers(this, _type_initializers, void 0);
                this.publicKey = (__runInitializers(this, _type_extraInitializers), __runInitializers(this, _publicKey_initializers, void 0));
        ...
        (() => {
            ...
            _publicKey_decorators = [(0, class_transformer_1.Transform)(({ value }) => value.id, {
                    toPlainOnly: true,
                })];
