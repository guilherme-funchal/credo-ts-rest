...
let ConnectionRepository = (() => {
    ...
    var ConnectionRepository = _classThis = class extends _classSuper {
        constructor(storageService, eventEmitter) {
            super(ConnectionRecord_1.ConnectionRecord, storageService, eventEmitter);
        }
        findByDids(agentContext_1, _a) {
            return __awaiter(this, arguments, void 0, function* (agentContext, { ourDid, theirDid }) {
