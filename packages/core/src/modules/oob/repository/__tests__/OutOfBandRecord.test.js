...
describe('OutOfBandRecord', () => {
    describe('getTags', () => {
        it('should return default tags', () => {
            const outOfBandRecord = new OutOfBandRecord_1.OutOfBandRecord({
                state: OutOfBandState_1.OutOfBandState.Done,
                role: OutOfBandRole_1.OutOfBandRole.Receiver,
                outOfBandInvitation: new messages_1.OutOfBandInvitation({
                    label: 'label',
                    services: [
                        new OutOfBandDidCommService_1.OutOfBandDidCommService({
                            id: 'id',
    ...
    describe('clone', () => {
        test('should correctly clone the record', () => {
            ...
            const oobRecord = utils_1.JsonTransformer.fromJSON(jsonRecord, OutOfBandRecord_1.OutOfBandRecord);
