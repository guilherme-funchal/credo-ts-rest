...
let BasicMessagesApi = (() => {
    let _classDecorators = [(0, plugins_1.injectable)()];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var BasicMessagesApi = _classThis = class {
         ...
         */
        sendMessage(connectionId, message, parentThreadId) {
            return __awaiter(this, void 0, void 0, function* () {
                const connection = yield this.connectionService.getById(this.agentContext, connectionId);
                const { message: basicMessage, record: basicMessageRecord } = yield this.basicMessageService.createMessage(this.agentContext, message, connection, parentThreadId);
         ...
         */
        getByThreadId(basicMessageRecordId) {
            return __awaiter(this, void 0, void 0, function* () {
         ...
         * @throws {RecordNotFoundError} If no record is found
         */
        deleteById(basicMessageRecordId) {
            return __awaiter(this, void 0, void 0, function* () {
                yield this.basicMessageService.deleteById(this.agentContext, basicMessageRecordId);
            });
        }
    ...
    __setFunctionName(_classThis, "BasicMessagesApi");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        BasicMessagesApi = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return BasicMessagesApi = _classThis;
})();
