...
let V2DeliveryRequestMessage = (() => {
    ...
    return _a = class V2DeliveryRequestMessage extends _classSuper {
            constructor(options) {
                super();
                ...
                this.limit = (__runInitializers(this, _recipientKey_extraInitializers), __runInitializers(this, _limit_initializers, void 0));
        ...
        (() => {
            ...
            _type_decorators = [(0, messageType_1.IsValidMessageType)(V2DeliveryRequestMessage.type)];
            ...
            _limit_decorators = [(0, class_validator_1.IsInt)()];
        ...
        _a.type = (0, messageType_1.parseMessageType)('https://didcomm.org/messagepickup/2.0/delivery-request'),
        _a;
})();
