...
let V2StatusRequestMessage = (() => {
    ...
    return _a = class V2StatusRequestMessage extends _classSuper {
            constructor(options) {
                super();
        ...
        (() => {
            ...
            _type_decorators = [(0, messageType_1.IsValidMessageType)(V2StatusRequestMessage.type)];
        ...
        _a.type = (0, messageType_1.parseMessageType)('https://didcomm.org/messagepickup/2.0/status-request'),
        _a;
})();
