...
let V1BatchPickupMessage = (() => {
    ...
    return _a = class V1BatchPickupMessage extends _classSuper {
            /**
            ...
            constructor(options) {
                ...
                this.batchSize = (__runInitializers(this, _type_extraInitializers), __runInitializers(this, _batchSize_initializers, void 0));
        ...
        (() => {
            ...
            _type_decorators = [(0, messageType_1.IsValidMessageType)(V1BatchPickupMessage.type)];
            _batchSize_decorators = [(0, class_validator_1.IsInt)(), (0, class_transformer_1.Expose)({ name: 'batch_size' })];
        ...
        _a.type = (0, messageType_1.parseMessageType)('https://didcomm.org/messagepickup/1.0/batch-pickup'),
        _a;
})();
