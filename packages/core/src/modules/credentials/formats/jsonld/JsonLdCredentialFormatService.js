...
class JsonLdCredentialFormatService {
    ...
    createProposal(agentContext_1, _a) {
        return __awaiter(this, arguments, void 0, function* (agentContext, { credentialFormats }) {
    ...
    acceptProposal(agentContext_1, _a) {
        return __awaiter(this, arguments, void 0, function* (agentContext, { attachmentId, proposalAttachment }) {
    ...
    createOffer(agentContext_1, _a) {
        return __awaiter(this, arguments, void 0, function* (agentContext, { credentialFormats, attachmentId }) {
            // if the offer has an attachment Id use that, otherwise the generated id of the formats object
            const format = new CredentialFormatSpec_1.CredentialFormatSpec({
                attachmentId,
                format: JSONLD_VC_DETAIL,
    ...
    acceptOffer(agentContext_1, _a) {
        return __awaiter(this, arguments, void 0, function* (agentContext, { attachmentId, offerAttachment }) {
    ...
    acceptRequest(agentContext_1, _a) {
        return __awaiter(this, arguments, void 0, function* (agentContext, { credentialFormats, attachmentId, requestAttachment }) {
            var _b, _c;
            ...
            const verificationMethod = (_c = (_b = credentialFormats === null || credentialFormats === void 0 ? void 0 : credentialFormats.jsonld) === null || _b === void 0 ? void 0 : _b.verificationMethod) !== null && _c !== void 0 ? _c : (yield this.deriveVerificationMethod(agentContext, credentialRequest.credential, credentialRequest));
            ...
            const verifiableCredential = yield w3cJsonLdCredentialService.signCredential(agentContext, {
     ...
     */
    deriveVerificationMethod(agentContext, credentialAsJson, credentialRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const issuerDidDocument = yield didResolver.resolveDidDocument(agentContext, issuerDid);
            ...
            const verificationMethod = yield (0, DidDocument_1.findVerificationMethodByKeyType)(keyType[0], issuerDidDocument);
            if (!verificationMethod) {
    ...
    processCredential(agentContext_1, _a) {
        return __awaiter(this, arguments, void 0, function* (agentContext, { credentialRecord, attachment, requestAttachment }) {
            ...
            const result = yield w3cCredentialService.verifyCredential(agentContext, { credential });
            if (result && !result.isValid) {
                throw new error_1.AriesFrameworkError(`Failed to validate credential, error = ${result.error}`);
            }
            const verifiableCredential = yield w3cCredentialService.storeCredential(agentContext, {
                credential,
            });
    ...
    shouldAutoRespondToCredential(agentContext_1, _a) {
        return __awaiter(this, arguments, void 0, function* (agentContext, { requestAttachment, credentialAttachment }) {
