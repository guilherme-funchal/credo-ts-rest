...
let CredentialPreviewAttribute = (() => {
    var _a;
    ...
    return _a = class CredentialPreviewAttribute {
            constructor(options) {
                this.name = __runInitializers(this, _name_initializers, void 0);
                this.mimeType = (__runInitializers(this, _name_extraInitializers), __runInitializers(this, _mimeType_initializers, 'text/plain'));
