...
let V2CredentialPreview = (() => {
    ...
    return _a = class V2CredentialPreview {
            constructor(options) {
        ...
        (() => {
            ...
            _type_decorators = [(0, class_transformer_1.Expose)({ name: '@type' }), (0, messageType_1.IsValidMessageType)(V2CredentialPreview.type), (0, class_transformer_1.Transform)(({ value }) => (0, messageType_1.replaceLegacyDidSovPrefix)(value), {
                    toClassOnly: true,
                })];
            _attributes_decorators = [(0, class_transformer_1.Type)(() => CredentialPreviewAttribute_1.CredentialPreviewAttribute), (0, class_validator_1.ValidateNested)({ each: true }), (0, class_validator_1.IsInstance)(CredentialPreviewAttribute_1.CredentialPreviewAttribute, { each: true })];
        ...
        _a.type = (0, messageType_1.parseMessageType)('https://didcomm.org/issue-credential/2.0/credential-preview'),
        _a;
})();
