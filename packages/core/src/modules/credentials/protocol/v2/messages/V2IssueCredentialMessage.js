...
let V2IssueCredentialMessage = (() => {
    ...
    return _a = class V2IssueCredentialMessage extends _classSuper {
            constructor(options) {
                var _b;
                super();
        ...
        (() => {
            ...
            _type_decorators = [(0, messageType_1.IsValidMessageType)(V2IssueCredentialMessage.type)];
            _comment_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            _credentialAttachments_decorators = [(0, class_transformer_1.Expose)({ name: 'credentials~attach' }), (0, class_transformer_1.Type)(() => Attachment_1.Attachment), (0, class_validator_1.IsArray)(), (0, class_validator_1.ValidateNested)({
                    each: true,
        ...
        _a.type = (0, messageType_1.parseMessageType)('https://didcomm.org/issue-credential/2.0/issue-credential'),
        _a;
})();
