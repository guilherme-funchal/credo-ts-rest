...
let W3cCredentialSubject = (() => {
    var _a;
    let _id_decorators;
    let _id_initializers = [];
    let _id_extraInitializers = [];
    return _a = class W3cCredentialSubject {
            constructor(options) {
        ...
        (() => {
            ...
            _id_decorators = [(0, validators_1.IsUri)(), (0, class_validator_1.IsOptional)()];
    ...
    return (0, class_transformer_1.Transform)(({ value, type }) => {
        if (type === class_transformer_1.TransformationType.PLAIN_TO_CLASS) {
            if ((0, class_validator_1.isString)(value))
                return value;
            return (0, class_transformer_1.plainToInstance)(W3cCredentialSubject, value);
        }
