...
describe('Jwt', () => {
    test('create Jwt instance from serialized jwt', () => {
        ...
        expect(jwtInstance.payload).toBeInstanceOf(JwtPayload_1.JwtPayload);
        ...
        expect(jwtInstance.signature.equals(utils_1.TypedArrayEncoder.fromBase64('anABxv424eMpp0xgbTx6aZvZxblkSThq-XbgixhWegFCVz2Q-EtRUiGJuOUjmql5TttTZ_YgtN9PgozOfuTZtg'))).toBe(true);
    });
});
