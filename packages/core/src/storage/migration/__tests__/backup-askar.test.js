...
const agentOptions = (0, helpers_2.getAgentOptions)('UpdateAssistant | Backup | Aries Askar', {}, {
...
(0, runInVersion_1.describeRunInNodeVersion)([18], 'UpdateAssistant | Backup | Aries Askar', () => {
    let updateAssistant;
    let agent;
    let backupPath;
