 ...
 */
function migrateConnectionRecordToV0_2(agent) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const connectionRecord of allConnections) {
            ...
            yield updateConnectionRoleAndState(agent, connectionRecord);
            yield extractDidDocument(agent, connectionRecord);
            ...
            const _connectionRecord = yield migrateToOobRecord(agent, connectionRecord);
 ...
 * ```
 */
function updateConnectionRoleAndState(agent, connectionRecord) {
    return __awaiter(this, void 0, void 0, function* () {
 ...
 * ```
 */
function extractDidDocument(agent, connectionRecord) {
    return __awaiter(this, void 0, void 0, function* () {
        agent.config.logger.debug(`Extracting 'didDoc' and 'theirDidDoc' from connection record into separate DidRecord and updating unqualified dids to did:peer dids`);
        ...
        if (oldOurDidDocJson) {
            ...
            let ourDidRecord = yield didRepository.findById(agent.context, newOurDidDocument.id);
            if (!ourDidRecord) {
                ...
                yield didRepository.save(agent.context, ourDidRecord);
        ...
        if (oldTheirDidDocJson) {
            ...
            // NOTE: in 0.3.0 the id property was updated to be a uuid, and a new did property was added. As this is the update from 0.1 to 0.2,
            // the `id` property of the record is still the did here.
            let theirDidRecord = yield didRepository.findById(agent.context, newTheirDidDocument.id);
            if (!theirDidRecord) {
                ...
                yield didRepository.save(agent.context, theirDidRecord);
 ...
 * ```
 */
function migrateToOobRecord(agent, connectionRecord) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (oldInvitationJson) {
            ...
            const oobRecords = yield oobRepository.findByQuery(agent.context, {
            ...
            if (!oobRecord) {
                ...
                yield oobRepository.save(agent.context, oobRecord);
            ...
            if (oldMultiUseInvitation) {
                ...
                yield oobRepository.update(agent.context, oobRecord);
                yield connectionRepository.delete(agent.context, connectionRecord);
