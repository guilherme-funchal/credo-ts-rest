...
let EnvelopeService = (() => {
    ...
    let _classThis;
    var EnvelopeService = _classThis = class {
        constructor(logger) {
            this.logger = logger;
        }
        packMessage(agentContext, payload, keys) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                let encryptedMessage = yield agentContext.wallet.pack(message, recipientKeysBase58, senderKeyBase58 !== null && senderKeyBase58 !== void 0 ? senderKeyBase58 : undefined);
                ...
                for (const routingKeyBase58 of routingKeysBase58) {
                    ...
                    encryptedMessage = yield agentContext.wallet.pack(forwardJson, [routingKeyBase58], undefined);
                }
                return encryptedMessage;
            });
        }
        unpackMessage(agentContext, encryptedMessage) {
            return __awaiter(this, void 0, void 0, function* () {
                const decryptedMessage = yield agentContext.wallet.unpack(encryptedMessage);
    ...
    __setFunctionName(_classThis, "EnvelopeService");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        EnvelopeService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return EnvelopeService = _classThis;
})();
