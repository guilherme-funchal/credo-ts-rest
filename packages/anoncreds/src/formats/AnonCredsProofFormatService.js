...
class AnonCredsProofFormatService {
    ...
    createProposal(agentContext_1, _a) {
        return __awaiter(this, arguments, void 0, function* (agentContext, { attachmentId, proofFormats }) {
            ...
            const proofRequest = (0, utils_1.createRequestFromPreview)({
                attributes: (_b = anoncredsFormat.attributes) !== null && _b !== void 0 ? _b : [],
                predicates: (_c = anoncredsFormat.predicates) !== null && _c !== void 0 ? _c : [],
                name: (_d = anoncredsFormat.name) !== null && _d !== void 0 ? _d : 'Proof request',
                version: (_e = anoncredsFormat.version) !== null && _e !== void 0 ? _e : '1.0',
    ...
    createRequest(agentContext_1, _a) {
        return __awaiter(this, arguments, void 0, function* (agentContext, { attachmentId, proofFormats }) {
            ...
            const request = {
                ...
                nonce: yield agentContext.wallet.generateNonce(),
                requested_attributes: (_b = anoncredsFormat.requested_attributes) !== null && _b !== void 0 ? _b : {},
                requested_predicates: (_c = anoncredsFormat.requested_predicates) !== null && _c !== void 0 ? _c : {},
    ...
    acceptRequest(agentContext_1, _a) {
        return __awaiter(this, arguments, void 0, function* (agentContext, { proofFormats, requestAttachment, attachmentId }) {
            ...
            const selectedCredentials = anoncredsFormat !== null && anoncredsFormat !== void 0 ? anoncredsFormat : (yield this._selectCredentialsForRequest(agentContext, requestJson, {
    ...
    getCredentialsForRequest(agentContext_1, _a) {
        return __awaiter(this, arguments, void 0, function* (agentContext, { requestAttachment, proofFormats }) {
            ...
            const proofRequestJson = requestAttachment.getDataAsJson();
            // Set default values
            const { filterByNonRevocationRequirements = true } = (_b = proofFormats === null || proofFormats === void 0 ? void 0 : proofFormats.anoncreds) !== null && _b !== void 0 ? _b : {};
