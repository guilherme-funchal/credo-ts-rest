...
class AnonCredsCredentialFormatService {
    ...
    acceptProposal(agentContext_1, _a) {
        return __awaiter(this, arguments, void 0, function* (agentContext, { attachmentId, credentialFormats, credentialRecord, proposalAttachment, }) {
            ...
            const credentialDefinitionId = (_b = anoncredsFormat === null || anoncredsFormat === void 0 ? void 0 : anoncredsFormat.credentialDefinitionId) !== null && _b !== void 0 ? _b : proposalJson.cred_def_id;
            const attributes = (_c = anoncredsFormat === null || anoncredsFormat === void 0 ? void 0 : anoncredsFormat.attributes) !== null && _c !== void 0 ? _c : credentialRecord.credentialAttributes;
            ...
            const { format, attachment, previewAttributes } = yield this.createAnonCredsOffer(agentContext, {
                credentialRecord,
                attachmentId,
                attributes,
    ...
    acceptOffer(agentContext_1, _a) {
        return __awaiter(this, arguments, void 0, function* (agentContext, { credentialRecord, attachmentId, offerAttachment, credentialFormats, }) {
            ...
            const { credentialRequest, credentialRequestMetadata } = yield holderService.createCredentialRequest(agentContext, {
                ...
                linkSecretId: (_b = credentialFormats === null || credentialFormats === void 0 ? void 0 : credentialFormats.anoncreds) === null || _b === void 0 ? void 0 : _b.linkSecretId,
            });
    ...
    createAnonCredsOffer(agentContext_1, _a) {
