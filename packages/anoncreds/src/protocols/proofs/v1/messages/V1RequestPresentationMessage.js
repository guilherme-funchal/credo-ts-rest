 ...
 */
let V1RequestPresentationMessage = (() => {
    var _a;
    ...
    return _a = class V1RequestPresentationMessage extends _classSuper {
            constructor(options) {
                var _b;
                super();
            ...
            get indyProofRequest() {
                ...
                return (_b = attachment === null || attachment === void 0 ? void 0 : attachment.getDataAsJson()) !== null && _b !== void 0 ? _b : null;
            }
        ...
        (() => {
            ...
            _type_decorators = [(0, core_1.IsValidMessageType)(V1RequestPresentationMessage.type)];
            _comment_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _requestAttachments_decorators = [(0, class_transformer_1.Expose)({ name: 'request_presentations~attach' }), (0, class_transformer_1.Type)(() => core_1.Attachment), (0, class_validator_1.IsArray)(), (0, class_validator_1.ValidateNested)({
                    each: true,
        ...
        _a.type = (0, core_1.parseMessageType)('https://didcomm.org/present-proof/1.0/request-presentation'),
        _a;
})();
