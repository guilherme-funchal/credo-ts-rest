 ...
 */
let V1CredentialProblemReportMessage = (() => {
    var _a;
    let _classSuper = core_1.ProblemReportMessage;
    let _type_decorators;
    let _type_initializers = [];
    let _type_extraInitializers = [];
    return _a = class V1CredentialProblemReportMessage extends _classSuper {
            /**
        ...
        (() => {
            ...
            _type_decorators = [(0, core_1.IsValidMessageType)(V1CredentialProblemReportMessage.type)];
            __esDecorate(null, null, _type_decorators, { kind: "field", name: "type", static: false, private: false, access: { has: obj => "type" in obj, get: obj => obj.type, set: (obj, value) => { obj.type = value; } }, metadata: _metadata }, _type_initializers, _type_extraInitializers);
            if (_metadata) Object.defineProperty(_a, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        })(),
        _a.type = (0, core_1.parseMessageType)('https://didcomm.org/issue-credential/1.0/problem-report'),
        _a;
})();
